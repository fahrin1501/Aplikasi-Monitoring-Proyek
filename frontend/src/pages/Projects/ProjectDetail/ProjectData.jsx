...
export default function ProjectData() {
  ...
  if (isLoading) return <div className="flex flex-col items-center justify-center min-h-[60vh] w-full"><Loader2 className="w-10 h-10 text-amber-500 animate-spin mb-4" /><p className="text-slate-500 font-medium">Memuat rincian proyek...</p></div>;
  if (errorMsg || !project) return <div className="flex flex-col items-center justify-center min-h-[60vh] w-full text-center"><AlertTriangle className="w-12 h-12 text-rose-500 mb-4" /><h2 className="text-lg font-bold text-slate-800 dark:text-white mb-2">Proyek Tidak Ditemukan</h2><button onClick={() => navigate('/projects')} className="px-6 py-2 bg-slate-200 dark:bg-slate-800 rounded-xl font-bold mt-4">Kembali ke Daftar</button></div>;
    ...
    <div className="w-full space-y-5 relative pb-20">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 shrink-0 mb-2">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-2 w-full lg:w-auto mt-2 lg:mt-0">
          ...
          {/* Action Buttons Navigasi Modul (DIBUKA UNTUK SEMUA ROLE TERMASUK TAMU) */}
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className={`bg-white dark:bg-slate-800/60 border p-4 md:p-5 rounded-2xl space-y-4 relative shadow-sm transition-all flex flex-col ${isEditMode ? 'border-blue-400/60 dark:border-blue-500/50 ring-2 ring-blue-500/10' : 'border-slate-200 dark:border-slate-700/60'}`}>
            ...
            <div className="space-y-3 text-xs flex-1 max-h-[300px] overflow-y-auto pr-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className={`bg-white dark:bg-slate-800/60 border p-4 md:p-5 rounded-2xl space-y-4 relative shadow-sm transition-all flex flex-col ${isEditMode ? 'border-blue-400/60 dark:border-blue-500/50 ring-2 ring-blue-500/10' : 'border-slate-200 dark:border-slate-700/60'}`}>
            ...
            <div className="space-y-2 text-xs flex-1 max-h-[300px] overflow-y-auto pr-1">
          ...
          <div className={`bg-white dark:bg-slate-800/60 border p-4 md:p-5 rounded-2xl space-y-3 relative shadow-sm transition-all flex flex-col ${isEditMode ? 'border-blue-400/60 dark:border-blue-500/50 ring-2 ring-blue-500/10' : 'border-slate-200 dark:border-slate-700/60'}`}>
            ...
            {isEditMode ? (
              ...
              <div className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed bg-slate-50 dark:bg-slate-900/60 p-4 rounded-xl border border-slate-200 dark:border-slate-700/50 flex-1 overflow-y-auto">
